export default {
  ...
  'settings.display.fontWeight': '字体粗细',
  'settings.display.fontWeight.light': '细',
  'settings.display.fontWeight.regular': '常规',
  'settings.display.fontWeight.medium': '中等',
  'settings.display.fontWeight.semibold': '半粗',
