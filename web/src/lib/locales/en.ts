export default {
  ...
  'settings.display.fontWeight.light': 'Light',
  'settings.display.fontWeight.regular': 'Regular',
  'settings.display.fontWeight.medium': 'Medium',
  'settings.display.fontWeight.semibold': 'Semibold',
